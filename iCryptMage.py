...
encryptButton = Button(win, text='Encrypt', command=encrypt,height=2)
decryptButton = Button(win,text='Decrypt', command=decrypt,height=2)
...
encryptButton.place(x=210,y=80)
